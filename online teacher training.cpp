...
//class Course
Course::Course(string id, string name, sring key, string type){
	courseId = id;
	courseName = name;
	enrollKey = key;
	courseType = type;
...
void Course::genarateCourseCertificate(string id, string name, string type, string c_no, string c_name, string c_date){
	...
	courseType = type;
	certificateNo = c_no;
	certificateName = c_name;
	certificateDate = c_date;
}
Course::~Course(){}
...
void Schedule::setSessionDetails(int s_id, string se_name){
	sessionId = s_id;
    sessionName = se_name;
}
...
//class Student
Student::Student(string s_id, string s_name, int s_nic, string s_dob){
	studentId = s_id;
    studentName = s_name;
    studentNIC = s_nic;
...
void Student::askQuestions(string s_id, string s_name, string stq_no){
	studentId = s_id;
    studentName = s_name;
    studentQuestionNo = stq_no;
}
Student::~Student(){}
...
//class Instructor
Instructor::Instructor(string i_id, string i_name, int i_contactno){
	instructorId = i_id;
...
void Exam::setExamGrade(string e_id,string e_name, char gr){
	examId = e_id;
    examName = e_name;
    grade = gr;
}
...
//class User
User::User(string em, string pswd){
	email = em;
    password = pswd;
}
